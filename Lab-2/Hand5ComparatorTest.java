...
public class Hand5ComparatorTest {
  ...
  @Test
  // StraightFlush 45678 v. StraightFlush 45678
  public void t13() {
  ...
  public void t15() {
    Hand5 h0 = new Hand5( new Card(Suit.DIAMOND, Value.FOUR),
                        new Card(Suit.CLUB, Value.TWO),
                        new Card(Suit.SPADE, Value.TWO),
                        new Card(Suit.CLUB, Value.FOUR),
                        new Card(Suit.HEART, Value.FOUR) );
